<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CafeteriaCRM.aspx.vb" Inherits="digitacion.CafeteriaCRM" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Development/StyleDesarrollo.css" rel="stylesheet" />
                    ...
                    <section>
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td style="width: 45%">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="TxtNombreProducto" MaxLength="80" CssClass="form-control" runat="server" />
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 45%">
                                        <div class="input-group">
                                            <div class="input-group-addon">Cantidad del Producto</div>
                                            <asp:TextBox ID="TxtCantidadProducto" MaxLength="80" CssClass="form-control" runat="server" />
                                        </div>
                                   ...
                                   <td style="width: 45%">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="TxtValor" MaxLength="80" CssClass="form-control" runat="server" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 45%">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="TxtFecha" MaxLength="80" CssClass="form-control" runat="server" />
                                        </div>
                                    </td>
